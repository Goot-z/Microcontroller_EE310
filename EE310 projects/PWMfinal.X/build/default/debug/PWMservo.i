...
# 143 "PWMservo.c"
    while (1)
    {
        ...
        if (!deployed && distance <= 10u)
        {
            deployed = 1;
        }
        else if (deployed && distance >= 13u)
        {
            deployed = 0;
        }
        ...
        if (deployed)
        {
            PWM2_LoadDutyValue(22u);
        }
        else
        {
            PWM2_LoadDutyValue(50u);
        }
