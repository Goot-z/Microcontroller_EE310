...
FINAL_IMAGE=${DISTDIR}/Temp_Sensor.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=Tempcode.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Tempcode.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Tempcode.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Tempcode.o

# Source Files
SOURCEFILES=Tempcode.asm
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Temp_Sensor.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F47K42
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Temp_Sensor.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Tempcode.o: Tempcode.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Tempcode.o 
	${MP_AS} -mcpu=PIC18F47K42 -c \
	-o ${OBJECTDIR}/Tempcode.o \
	Tempcode.asm \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/Temp_Sensor.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F47K42 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/Temp_Sensor.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
