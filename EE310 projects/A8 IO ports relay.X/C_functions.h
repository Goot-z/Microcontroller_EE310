...
//---------------------
// Program Details:
// Functions for "Photoresistor lockbox.c"
//    
// Date: 4/16/2025
...
/* These functions control the buzzer output. */
void BUZZER_On(void);                 // activates the relay so the buzzer/load can be powered
void BUZZER_Off(void);                // deactivates the relay so the buzzer/load is turned off
