...
SOURCEFILES_QUOTED_IF_SPACED=sevenSegment.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/sevenSegment.o
POSSIBLE_DEPFILES=${OBJECTDIR}/sevenSegment.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/sevenSegment.o

# Source Files
SOURCEFILES=sevenSegment.asm
...
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Assignment_6.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/sevenSegment.o: sevenSegment.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/sevenSegment.o 
	${MP_AS} -mcpu=PIC18F47K42 -c \
	-o ${OBJECTDIR}/sevenSegment.o \
	sevenSegment.asm \
...
${DISTDIR}/Assignment_6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o ${DISTDIR}/Assignment_6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
